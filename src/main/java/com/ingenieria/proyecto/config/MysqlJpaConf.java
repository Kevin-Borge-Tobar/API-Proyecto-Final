package com.ingenieria.proyecto.config;
...
@EnableJpaRepositories(
        basePackages = "com.ingenieria.proyecto.repositories",
...
public class MysqlJpaConf {
    ...
    public EntityManagerFactory builEntityMangerMysql(){
        ...
        locaContainer.setPackagesToScan("com.ingenieria.proyecto.entities");
